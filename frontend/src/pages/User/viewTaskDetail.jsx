...
const Attachments = ({link,index,onClick})=>{
  return <div className='flex justify-between bg-gray-100 px-3 py-2 rounded-md mt-2 mb-3 cursor-pointer'
     onClick={onClick}>
       <div className='flex-1 flex-items-center border border-gray-100'>
