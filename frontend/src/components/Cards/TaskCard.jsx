...
const TaskCard = ({
  ...
  const getPriorityTagColor = ()=>{
    switch (priority) {
      case "Low":
        return 'bg-emerald-500 bg-emerald-50 border border-red-500/10';
      case "Medium":
        return 'bg-amber-500 bg-amber-50 border border-amber-500/10';
      default:
        return 'bg-rose-500 bg-rose-50 border border-rose-500/10';
  }
}
  return (
